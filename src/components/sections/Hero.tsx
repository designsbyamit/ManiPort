    ...
    <section className="relative min-h-screen flex items-center overflow-hidden grain-overlay">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-32">
        <div className="flex flex-col max-w-5xl">
          ...
          >
            UX Designer · Based in Bengaluru
          </motion.p>
          ...
          >
            ...
            a{' '}
            <TypewriterText
              words={['designer', 'problem-solver', 'artist']}
              className="text-accent italic"
            />
            ,
            <br />
            who simplifies the complexity
            <br />
          ...
          <motion.p
            {...fadeUp(0.3)}
            className="text-[var(--muted)] text-lg mt-8 max-w-2xl leading-relaxed font-sans"
          >
